...
class UI {
    constructor() {
       this._waitingQueue = new WaitingQueue();
    }
    ...
    addNewPatient() {
      ...
      this._waitingQueue.pushPatient(p);
    ...
    callNextPatient() {
      let nextPatient = this._waitingQueue.shiftPatient();
      if (nextPatient != null) {
    ...
    updateNumberOfWaitingPatients() {
      let numberOfWaitingPatients = this._waitingQueue.getNumberOfWaitingPatients();
